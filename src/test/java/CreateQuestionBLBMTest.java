...
public class CreateQuestionBLBMTest {
	...
	public void test1() {
			try {
				...
				Mockito.doReturn(new Question(queryText,mockedEvent)).when(dataAccess).createQuestion(Mockito.any(Event.class),Mockito.any(String.class));

				

				//invoke System Under Test (sut) 
				Question q=sut.createQuestion(mockedEvent, queryText);
	...
	public void test3() {
		try {
			...
			//invoke System Under Test (sut) 
			Question q=sut.createQuestion(null, queryText);
