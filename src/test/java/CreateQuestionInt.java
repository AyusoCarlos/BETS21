...
public class CreateQuestionInt {
	...
	public void test1() {
		try {
			...
			ev = testBL.addEventWithQuestion(eventText,oneDate,queryText );
			
			
			//invoke System Under Test (sut)  
			sut.createQuestion(ev, queryText);
	...
	public void test2() {
		try {
			...
			//configure the state of the system (create object in the dabatase)
			ev = testBL.addEventWithQuestion(eventText,oneDate,"query2" );
			
			//invoke System Under Test (sut)  
			Question q=sut.createQuestion(ev, queryText);
