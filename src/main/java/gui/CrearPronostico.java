...
public class CrearPronostico extends JFrame {
	...
	public static CrearPronostico frame;
	...
	private final JButton pronos = new JButton("crear");
...
//		});
	//}
	public CrearPronostico(User usuario)
	{
...
//					jCalendar1.setCalendar(calendarAct);
		...
		pronos.setFont(new Font("Segoe UI Symbol", Font.PLAIN, 13));
		pronos.setBounds(282, 423, 124, 29);
		
		getContentPane().add(pronos);
		
		
		
	
				pronos.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						Question q=ev.getQuestions().get(tableQueries.getSelectedRow());
							...
							JFrame n = new CrearPronostico2(usuario,ev,q);
								n.setVisible(true);		
