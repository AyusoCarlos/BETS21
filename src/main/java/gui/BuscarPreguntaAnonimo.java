...
public class BuscarPreguntaAnonimo extends JFrame {
	...
	private final JButton VerPro = new JButton("Ver pronosticos");
	public BuscarPreguntaAnonimo()
	{
...
//					jCalendar1.setCalendar(calendarAct);
		...
		VerPro.setBounds(262, 412, 155, 40);
		
		getContentPane().add(VerPro);
		
		VerPro.addActionListener(new ActionListener() {
