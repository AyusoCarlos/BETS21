...
public class Event implements Serializable {
	...
	public Event(Integer eventNumber, String description,Date eventDate,Categoria Categoria) {
		this.eventNumber = eventNumber;
		this.description = description;
		this.eventDate=eventDate;
		this.cont=questions.size();
		this.Categoria= Categoria;
	}
	
	public Event(Integer eventNumber, String description,Date eventDate, boolean acabado) {
